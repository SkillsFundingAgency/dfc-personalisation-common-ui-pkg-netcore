...
{
    // Based on https://benjii.me/2017/01/is-active-route-tag-helper-asp-net-mvc-core/
    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        /// <summary>The css class used to indicate the active link.</summary>
        [HtmlAttributeName("active-route-class")]
        public string ActiveRouteClass { get; set; }
